...
_PORTALS: tuple[PortalInfo, ...] = (
    ...
    PortalInfo(
        key="bub_digitale",
        label="BUB Digitale (Biblioteca Universitaria Bologna)",
        group="\u2500\u2500 Italia \u2500\u2500",
        area="Italia / Emilia-Romagna",
        technical_family="iiif_direct",
        method="IIIF diretto da parametro manifest BUB",
        maintenance_risk="Basso-Medio",
        roadmap_priority="maintain_with_warning",
        operational_note="Bollettini e collezioni IIIF pubbliche; verificare sempre licenza item-level e usare range esplicito.",
        default_referer="https://bub.unibo.it",
        tile_max_workers=1,
        tile_inter_delay=0.3,
        record_mode_policy="r_limited",
        policy_checked_at="2026-06-08",
        policy_source_urls=(
            "https://bub.unibo.it/it/bub-digitale",
            "https://bub.unibo.it/it/bub-digitale/bollettini-parrocchiali",
            "https://bub.unibo.it/it/bub-digitale/termini-d-uso",
        ),
    ),
    PortalInfo(
        key="biblioteca_digitale_trentina",
        label="Biblioteca Digitale Trentina",
        group="\u2500\u2500 Italia \u2500\u2500",
        area="Italia / Trentino",
        technical_family="synthetic_manifest",
        method="Manifest sintetico da immagini pubbliche in pagina",
        maintenance_risk="Basso-Medio",
        roadmap_priority="maintain_with_warning",
        operational_note="Materiali in pubblico dominio con riuso e citazione; per testi a stampa preferire il PDF diretto quando disponibile.",
        default_referer="https://bdt.bibcom.trento.it",
        record_mode_policy="r_limited",
        policy_checked_at="2026-06-06",
        policy_source_urls=(
            "https://bdt.bibcom.trento.it/",
            "https://bdt.bibcom.trento.it/Riuso",
            "https://www.comune.trento.it/Servizi/Biblioteca-Digitale-Trentina-BDT",
        ),
    ),
    PortalInfo(
        key="biblioteca_digitale_lombarda",
        label="Biblioteca Digitale Lombarda",
        group="\u2500\u2500 Italia \u2500\u2500",
        area="Italia / Lombardia",
        technical_family="synthetic_manifest",
        method="Manifest sintetico da PDF REST pubblico",
        maintenance_risk="Basso-Medio",
        roadmap_priority="maintain_with_warning",
        operational_note="Solo PDF puntuali pubblici; niente immagini/registro finche IIIF o sequenze non risultano stabili.",
        default_referer="https://www.bdl.servizirl.it",
        record_mode_policy="d_only",
        policy_checked_at="2026-06-08",
        policy_source_urls=(
    ...
    PortalInfo(
        key="rovereto_digital_library",
        label="Rovereto Digital Library",
        group="\u2500\u2500 Italia \u2500\u2500",
        area="Italia / Trentino",
        technical_family="synthetic_manifest",
        method="Manifest sintetico da API DSpace-GLAM",
        maintenance_risk="Medio",
        roadmap_priority="maintain_with_warning",
        operational_note="Solo bitstream pubblici classificati come pagine; licenza item-level da verificare.",
        default_referer="https://digitallibrary.bibliotecacivica.rovereto.tn.it",
        tile_max_workers=1,
        tile_inter_delay=0.3,
        record_mode_policy="r_limited",
        policy_checked_at="2026-06-08",
        policy_source_urls=(
            "https://digitallibrary.bibliotecacivica.rovereto.tn.it/",
            "https://digitallibrary.bibliotecacivica.rovereto.tn.it/info/end-user-agreement",
        ),
    ),
    PortalInfo(
        key="memooria",
