...
def compose_ocr_prompt(doc_type, user_instructions="", example_text=""):
    ...
    type_specific = {
        ...
        "Stati delle Anime Granducato di Toscana": (
            ...
            " 'Bertoni' rimane 'Bertoni' (non 'Bertini'), 'Luigia' rimane 'Luigia' (non 'Luisa'),"
            " 'Angiolo' rimane 'Angiolo' (non 'Angelo'), 'Sante' rimane 'Sante' (non 'Santi'),"
            " 'Angiolino' rimane 'Angiolino' (non 'Angelino'), 'Andrei' rimane 'Andrei' (non 'Andreini').\n"
            ...
            " può essere ambigua. Applica SEMPRE la procedura 3-step: conta la posizione della casella"
            " barrata (1-3=maschio, 4-6=femmina), POI leggi il nome. Se la casella indica maschio ma"
            " il nome letto termina in -a (es. 'Irena', 'Irene', 'Rosa', 'Maria') o sembra femminile,"
            " rilegi il nome con attenzione: probabilmente è 'Pietro', 'Giovanni', 'Giuseppe' ecc."
            " Se non riesci a determinare il nome corretto, scrivi il nome letto seguito da [?].\n"
            ...
            "- ESEMPIO RIGA NEONATO MASCHIO: un bambino di 1 anno nel nucleo familiare di un"
            " Ammogliato avrà stato civile Celibe (col.7=1). Il nome in corsivo può apparire"
            " femminile (es. 'Irene') ma la casella Celibe (prima delle sei) lo identifica"
            " come maschio. In tal caso applica la gender rule e leggi il nome come maschile.\n"
        ),
        "Stato delle Anime / Censimento Parrocchiale": (
