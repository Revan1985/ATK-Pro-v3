...
def get_available_types():
    return [
        ...
        "Foglio di Famiglia Anagrafe Comunale (post-1864)",
        "Testamento (atto notarile specifico)",
        "Matrimonio Religioso post-Concordato (1929+)",
    ]
...
def compose_ocr_prompt(doc_type, user_instructions="", example_text=""):
    ...
    type_specific = {
        ...
        # --- Catasto Onciario (Due Sicilie, sec. XVIII) ---
        "Catasto Onciario (Due Sicilie, sec. XVIII)": (
            "\nTIPOLOGIA: Catasto Onciario del Regno delle Due Sicilie (sec. XVIII).\n"
            "Registro fiscale e censuario redatto per fini tributari e demografici.\n"
            "\nSTRUTTURA DEL DOCUMENTO:\n"
            "- Elenco delle famiglie (fuochi) con capofamiglia, componenti, età, professione, beni posseduti.\n"
            "- Indicazione del luogo (università/comune), anno, autorità redigente.\n"
            "- Spesso suddiviso in colonne: nome, cognome, stato, beni, rendite, osservazioni.\n"
            "\nREGOLE PALEOGRAFICHE:\n"
            "- Trascrivi fedelmente nomi, cognomi, toponimi e termini fiscali.\n"
            "- Mantieni la struttura tabellare, separando le colonne con tabulazioni o punti e virgola.\n"
            "- Indica le abbreviazioni sciolte tra < >.\n"
            "- Riporta eventuali annotazioni marginali con [MARGINE: ...].\n"
        ),
        # --- Rivele / Numerazione dei Fuochi (Due Sicilie, sec. XVI-XVII) ---
        "Rivele / Numerazione dei Fuochi (Due Sicilie, sec. XVI-XVII)": (
            "\nTIPOLOGIA: Rivele o Numerazione dei Fuochi (Due Sicilie, sec. XVI-XVII).\n"
            "Censimento fiscale e demografico antico, redatto per la tassazione delle famiglie (fuochi).\n"
            "\nSTRUTTURA DEL DOCUMENTO:\n"
            "- Elenco di capifamiglia, componenti, età, professione, stato civile, beni.\n"
            "- Indicazione del luogo, anno, autorità redigente.\n"
            "- Spesso in forma tabellare o elenco puntato.\n"
            "\nREGOLE PALEOGRAFICHE:\n"
            "- Trascrivi fedelmente nomi, cognomi, toponimi e termini fiscali.\n"
            "- Mantieni la struttura originale (colonne, punti elenco).\n"
            "- Indica le abbreviazioni sciolte tra < >.\n"
            "- Riporta eventuali annotazioni marginali con [MARGINE: ...].\n"
        ),
        # --- Catasto Murattiano (Due Sicilie, 1808-1815) ---
        "Catasto Murattiano (Due Sicilie, 1808-1815)": (
            "\nTIPOLOGIA: Catasto Murattiano (Due Sicilie, 1808-1815).\n"
            "Registro catastale introdotto durante il regno di Gioacchino Murat.\n"
            "\nSTRUTTURA DEL DOCUMENTO:\n"
            "- Elenco di possessori di beni immobili, con nome, cognome, descrizione dei beni, estensione, rendita.\n"
            "- Indicazione del comune, anno, autorità catastale.\n"
            "- Spesso suddiviso in colonne: proprietario, natura del bene, confini, valore.\n"
            "\nREGOLE PALEOGRAFICHE:\n"
            "- Trascrivi fedelmente nomi, cognomi, toponimi e termini catastali.\n"
            "- Mantieni la struttura tabellare, separando le colonne con tabulazioni o punti e virgola.\n"
            "- Indica le abbreviazioni sciolte tra < >.\n"
            "- Riporta eventuali annotazioni marginali con [MARGINE: ...].\n"
        ),
        # --- Catasto Gregoriano (Stato Pontificio, 1816-1835) ---
        "Catasto Gregoriano (Stato Pontificio, 1816-1835)": (
            "\nTIPOLOGIA: Catasto Gregoriano (Stato Pontificio, 1816-1835).\n"
            "Registro catastale introdotto da papa Gregorio XVI per la rilevazione dei beni immobili.\n"
            "\nSTRUTTURA DEL DOCUMENTO:\n"
            "- Elenco di possessori, beni, estensione, rendita, confini.\n"
            "- Indicazione del comune, anno, autorità catastale.\n"
            "- Spesso suddiviso in colonne: proprietario, natura del bene, valore, osservazioni.\n"
            "\nREGOLE PALEOGRAFICHE:\n"
            "- Trascrivi fedelmente nomi, cognomi, toponimi e termini catastali.\n"
            "- Mantieni la struttura tabellare, separando le colonne con tabulazioni o punti e virgola.\n"
            "- Indica le abbreviazioni sciolte tra < >.\n"
        ...
        # --- Foglio Matricolare (scheda individuale, 1865-1940) ---
        "Foglio Matricolare (scheda individuale, 1865-1940)": (
            "\nTIPOLOGIA: Foglio Matricolare (scheda individuale, 1865-1940).\n"
            "Documento militare individuale che riporta la carriera, i dati anagrafici e i servizi prestati dal soldato.\n"
            "\nSTRUTTURA DEL DOCUMENTO:\n"
            "- Dati anagrafici: nome, cognome, data e luogo di nascita, paternità, professione.\n"
            "- Dati militari: classe, distretto, numero di matricola, grado, corpo di appartenenza, campagne, ferite, decorazioni.\n"
            "- Annotazioni su congedi, trasferimenti, cause di cessazione dal servizio.\n"
            "\nREGOLE PALEOGRAFICHE:\n"
            "- Trascrivi fedelmente tutti i dati, mantenendo la struttura tabellare o a blocchi.\n"
            "- Indica le abbreviazioni sciolte tra < >.\n"
            "- Riporta eventuali annotazioni marginali con [MARGINE: ...].\n"
        ),
        "SCN — Atto di Nascita (1806-1815)": (
        ...
        "SCR — Atto di Morte (1815-1865)": (
            ...
            "- Causa di morte: spesso in terminologia arcaica o dialettale meridionale\n"
        ...
        "SCR/Veneto — Atto di Matrimonio (1816-1866)": (
            ...
            "- Sposa: stesse informazioni; cognome da nubile.\n"
            "- Eventuali atti preliminari citati: pubblicazioni (banns), nulla o sta, dispense.\n"
        ...
        "SCI — Atto di Matrimonio (dal 1866)": (
            ...
            "- Consensi dei genitori se minorenni, o nulla o sta se maggiorenni.\n"
            "- Dichiarazione di volontà: formula 'Dichiaro di voler prendere per mio/a sposo/a'"
            " o equivalente; risposta dell'altro sposo.\n"
        ...
        "SCI — Atto di Morte (dal 1866)": (
            ...
            "  Se coniugato o vedovo: nome e cognome del coniuge (cognome da nubile per le donne),\n"
            "  nomi dei genitori (con 'fu' se defunti).\n"
        ...
        "Atto di Stato Civile (Matrimonio)": (
            ...
            "- Il termine 'fu' indica genitore defunto: trascrivi letteralmente.\n"
        ...
        "Registro Parrocchiale — Battesimi (sec. XVI-XIX)": (
            ...
            "  ('in cassum' o 'sub conditione'): trascrivilo per intero.\n"
        ...
        "Registro Parrocchiale — Cresimati (sec. XVI-XIX)": (
            ...
            "- Età: trascrivi esattamente come scritto, anche se approssimativa.\n"
            "- MARGINALIA: trascrivi con il tag [MARGINE: ...].\n"
        ...
        "Catasto Murattiano (Due Sicilie, 1808-1815)": (
            ...
            "- Confini: 'a settentrione', 'a mezzogiorno', 'a levante', 'a ponente':\n"
        ...
        "Ruolo di Matricola / Leva Militare (1865-1940)": (
            ...
            "- MARGINALIA: trascrivi annotazioni a margine con il tag [MARGINE: ...].\n"
            "- DOPPIA PAGINA: se l'immagine mostra due pagine affiancate (foglio aperto),\n"
            "  le colonne di sinistra e di destra formano insieme un'unica riga: trascrivile unite da ' | '.\n"
        ),
        "Foglio Matricolare (scheda individuale, 1865-1940)": (
        ...
        "Passaporto / Permesso di Espatrio (sec. XIX-XX)": (
            ...
            "  - Nulla o sta / permesso di emigrazione: formato ministeriale (Commissariato\n"
        ...
        "Registro dei Defunti Ospedalieri": (
            ...
            "\nFORMATO:\n"
            "- Prevalentemente tabellare: usa ' | ' come separatore di colonna con riga di intestazione.\n"
        ...
        "Foglio di Famiglia Anagrafe Comunale (post-1864)": (
            "\nTIPOLOGIA: Foglio di Famiglia dell'Anagrafe Comunale (post-1864, R.D. 31/12/1864 n. 2105).\n"
            "Documento originale del registro anagrafico, aggiornato nel tempo con tutte le variazioni\n"
            "(nascite, matrimoni, morti, trasferimenti, cambi di residenza).\n"
            "\nSTRUTTURA TIPICA:\n"
            "- Intestazione: Comune, sezione, numero del foglio, data di apertura.\n"
            "- Intestazione del capofamiglia: nome, cognome, data e luogo di nascita, professione.\n"
            "- Elenco dei componenti: per ciascuno, nome, cognome, data e luogo di nascita,\n"
            "  relazione col capofamiglia, stato civile, professione, note.\n"
            "- Sezioni cronologiche: per ogni variazione (nascita, matrimonio, morte, trasferimento),\n"
            "  data e descrizione dell'evento, autorità che lo registra.\n"
            "- Annotazioni marginali: cambi di cognome, adozioni, cittadinanza, note di polizia.\n"
            "\nREGOLE PALEOGRAFICHE:\n"
            "- Trascrivi OGNI variazione cronologica, anche se barrata o annullata.\n"
            "- Usa ' | ' come separatore se il foglio è tabellare; altrimenti, trascrivi come scheda\n"
            "  con una riga per ogni campo.\n"
            "- MARGINALIA: trascrivi con [MARGINE: ...].\n"
        ),
        "Testamento (atto notarile specifico)": (
            "\nTIPOLOGIA: Testamento pubblico, segreto olografo, atto di ultima volontà.\n"
            "Redatto dal notaio o dal testatore stesso; struttura e formule proprie.\n"
            "\nSTRUTTURA TIPICA:\n"
            "- Intestazione: luogo, data, notaio, eventuali testimoni.\n"
            "- Dichiarazione di capacità e volontà del testatore.\n"
            "- Istituzione di eredi, legati, disposizioni particolari.\n"
            "- Clausole pie (messe, lasciti a chiesa, opere di carità).\n"
            "- Nomina di esecutori testamentari.\n"
            "- Formula di chiusura e firme.\n"
            "\nREGOLE PALEOGRAFICHE:\n"
            "- Trascrivi tutte le formule di rito, anche se ripetitive.\n"
            "- Nomi delle parti: trascrivi esattamente, compresi titoli e soprannomi.\n"
            "- 'Fu' indica genitore defunto: trascrivi letteralmente.\n"
            "- MARGINALIA: trascrivi con [MARGINE: ...].\n"
        ),
        "Matrimonio Religioso post-Concordato (1929+)": (
            "\nTIPOLOGIA: Atto di matrimonio religioso con effetti civili (Concordato Lateranense, 1929+).\n"
            "Redatto dal parroco e trasmesso all'Ufficiale di Stato Civile; struttura ibrida\n"
            "ecclesiastica-civile.\n"
            "\nSTRUTTURA TIPICA:\n"
            "- Intestazione: parrocchia, comune, data, parroco celebrante.\n"
            "- Sposo: nome, cognome, età o data di nascita, luogo di nascita, professione, domicilio,\n"
            "  stato civile (celibe/vedovo), religione, nome e cognome del padre e della madre.\n"
            "- Sposa: stesse informazioni; cognome da nubile.\n"
            "- Tre pubblicazioni canoniche (date).\n"
            "- Dichiarazione di assenza di impedimenti.\n"
            "- Celebrazione del matrimonio secondo il rito religioso.\n"
            "- Formula di trasmissione all'Ufficiale di Stato Civile per la trascrizione.\n"
            "- Firme degli sposi, testimoni, parroco.\n"
            "\nREGOLE PALEOGRAFICHE:\n"
            "- Trascrivi tutte le formule canoniche e civili.\n"
            "- 'Fu' indica genitore defunto: trascrivi letteralmente.\n"
            "- MARGINALIA: trascrivi con [MARGINE: ...].\n"
        ),
    }
