...
| `bub_digitale` | BUB Digitale / Biblioteca Universitaria di Bologna | Italia / Emilia-Romagna | `https://bub.unibo.it/it/bub-digitale` | Media-alta: papiri, manoscritti greci/arabi/ebraici, opere a stampa, periodici storici, bollettini parrocchiali, fotografie e fondi bolognesi utili al contesto storico-familiare | Controllo 2026-06-08: fonte ufficiale BUB descrive accesso libero e gratuito per studio/ricerca, uso dello standard IIIF e visualizzatore Mirador. La pagina segnala collezioni molto interessanti, compresi bollettini parrocchiali bolognesi. Non e ancora stato eseguito un probe ATK-Pro su item/manifest, ne una verifica item-level delle licenze | B - candidato IIIF forte da sondare; nessuna integrazione finche manifest, diritti e download consentito non sono verificati su campioni stabili |
...
| `bub_digitale` | Italia / Emilia-Romagna | pagina ufficiale BUB Digitale, IIIF e Mirador dichiarati | Nuovo candidato forte per sonda IIIF: collezioni storiche e bollettini parrocchiali, ma termini e campioni item-level da verificare |
