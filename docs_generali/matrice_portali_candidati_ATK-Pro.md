...
| `orientales_unior` | Italia / Campania | pagina ufficiale OrienTales, IIIF, Mirador, OCR, metadati e download se licenza lo permette; sonda aggiornata per DSpace/Omeka con `verify_orientales_technical_probe.py` | Candidato promettente ma condizionato: download solo dove la licenza dell'oggetto lo consente |
