...
| `bub_digitale` | BUB Digitale / Biblioteca Universitaria di Bologna | Italia / Emilia-Romagna | `https://bub.unibo.it/it/bub-digitale`; `https://bub.unibo.it/it/bub-digitale/bollettini-parrocchiali`; campione `https://bub.unibo.it/it/bub-digitale/bollettini-parrocchiali/l-angelo-della-famiglia-bollettino-parrocchiale-di-bondanello-castelmaggiore-bologna?manifest=https%3A%2F%2Fbub.unibo.it%2Fiiif%2F2%2Fmanifest%2Fbub%2Fbollettiniparrocchiali%2F_castelmaggiore_-_s_bartolomeo_di_bondanello%2Fjpg%2F1934.json&view=BookView` | Media-alta: papiri, manoscritti greci/arabi/ebraici, opere a stampa, periodici storici, bollettini parrocchiali, fotografie e fondi bolognesi utili al contesto storico-familiare | Controllo 2026-06-08: fonte ufficiale BUB descrive accesso libero e gratuito per studio/ricerca, uso dello standard IIIF e visualizzatore Mirador. La landing page live espone soprattutto pagine del portale e immagini Plone `@@images`, ora classificate come `plone_page_image` per non confonderle con pagine documento. I risultati di ricerca pubblici mostrano pagine dei bollettini parrocchiali con parametro `manifest=` verso IIIF v2: da testare con `verify_bub_technical_probe.py` su URL di oggetto/anno, non sulla landing | B - candidato IIIF forte da sondare su campioni specifici; nessuna integrazione finche manifest, diritti e download consentito non sono verificati su campioni stabili |
| `dl_ficlit` | FICLIT Digital Library / Universita di Bologna | Italia / Emilia-Romagna | `https://dl.ficlit.unibo.it/s/lib/page/progetto` | Media: collezioni accademiche e umanistiche, fonti letterarie, bibliografiche e documentarie utili a ricerche storiche territoriali | Controllo 2026-06-08: fonte ufficiale descrive piattaforma Omeka S, tecnologia IIIF per immagini e visualizzazione con Mirador Viewer. `verify_ficlit_technical_probe.py` e disponibile per cercare pagine Omeka, item/media/API, viewer Mirador, manifest IIIF, info.json e immagini candidate. Servono campioni reali, verifica dei termini di riuso e distinzione tra collezioni liberamente scaricabili e sola consultazione | B - candidato tecnico Omeka/IIIF da sondare dopo BUB; no downloader prima della verifica policy |
| `orientales_unior` | OrienTales / Biblioteca digitale Universita di Napoli L'Orientale | Italia / Campania | `https://www.unior.it/it/biblioteche/servizi-gli-utenti/biblioteca-digitale` | Media-alta: libri antichi, manoscritti in lingue orientali, materiale d'archivio, documentario, periodici, collane, carte geografiche e atlanti, con valore culturale e storico per ricerche italiane | Controllo 2026-06-08: fonte ufficiale indica licenze Creative Commons, framework IIIF, uso di Mirador, download laddove la licenza lo permetta, OCR e scarico metadati. `verify_orientales_technical_probe.py` e disponibile per cercare pagina Unior, record Omeka se presenti, viewer Mirador, manifest IIIF, info.json, immagini, OCR/testi e metadati candidati. Il download non e generalizzabile senza leggere la licenza dell'oggetto | B - candidato IIIF/Mirador da sondare con policy prudente `R_LIMITED` solo se i campioni confermano download consentito |
...
| `bub_digitale` | Italia / Emilia-Romagna | pagina ufficiale BUB Digitale, IIIF e Mirador dichiarati; `verify_bub_technical_probe.py` | Nuovo candidato forte per sonda IIIF: collezioni storiche e bollettini parrocchiali, ma termini e campioni item-level da verificare |
| `dl_ficlit` | Italia / Emilia-Romagna | pagina ufficiale DL FICLIT, Omeka S, IIIF e Mirador dichiarati; `verify_ficlit_technical_probe.py` | Candidato tecnico Omeka/IIIF; utile dopo BUB per capire se emerge un adapter riusabile |
| `orientales_unior` | Italia / Campania | pagina ufficiale OrienTales, IIIF, Mirador, OCR, metadati e download se licenza lo permette; `verify_orientales_technical_probe.py` | Candidato promettente ma condizionato: download solo dove la licenza dell'oggetto lo consente |
