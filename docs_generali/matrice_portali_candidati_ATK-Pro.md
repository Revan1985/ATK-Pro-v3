...
| `bub_digitale` | BUB Digitale / Biblioteca Universitaria di Bologna | Italia / Emilia-Romagna | `https://bub.unibo.it/it/bub-digitale` | Media-alta: papiri, manoscritti greci/arabi/ebraici, opere a stampa, periodici storici, bollettini parrocchiali, fotografie e fondi bolognesi utili al contesto storico-familiare | Controllo 2026-06-08: fonte ufficiale BUB descrive accesso libero e gratuito per studio/ricerca, uso dello standard IIIF e visualizzatore Mirador. La pagina segnala collezioni molto interessanti, compresi bollettini parrocchiali bolognesi. `verify_bub_technical_probe.py` e disponibile per cercare pagine/record BUB, viewer Mirador, manifest IIIF, info.json e immagini candidate, ma non e ancora stato validato un campione live stabile | B - candidato IIIF forte da sondare; nessuna integrazione finche manifest, diritti e download consentito non sono verificati su campioni stabili |
