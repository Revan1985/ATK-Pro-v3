...
| `dl_ficlit` | Italia / Emilia-Romagna | pagina ufficiale DL FICLIT, Omeka S, IIIF e Mirador dichiarati; `verify_ficlit_technical_probe.py`; `verify_manifest_url.py` | Due campioni positivi: Corbiere `199245`, 1 canvas, e Camporesi `28429`, 239 canvas; preparare adapter prudente solo con range esplicito e verifica termini item-level |
