...
| `biblioteca_digitale_trentina` | Biblioteca Digitale Trentina | Italia / Trentino e area ex asburgica | `https://bdt.bibcom.trento.it/`; `https://bdt.bibcom.trento.it/Riuso`; `https://www.comune.trento.it/Servizi/Biblioteca-Digitale-Trentina-BDT` | Alta per storia locale, Trentino, mobilita alpina, cartoline, periodici, carte geografiche, stampe e fonti bibliografiche di contesto | Controllo 2026-06-05: fonte istituzionale pubblica, accesso libero, download gratuito delle immagini e pagina di riuso molto favorevole: materiali in pubblico dominio, riuso anche commerciale con citazione; da verificare tecnicamente se esistono endpoint diretti, IIIF o pattern immagini stabili | A/B - primo candidato italiano da sondare dopo Siena; probabile `R_OK`/`R_LIMITED` solo dopo prova tecnica live e fixture offline |
| `beic_digitale` | BEIC digital library | Italia / Lombardia | `https://digital.beic.it/`; `https://digital.beic.it/termini-duso/`; `https://digital.beic.it/infrastruttura-e-standard/` | Alta per libri antichi, manoscritti, periodici, editoria lombarda e fonti bibliografiche utili alla ricerca genealogica e territoriale | Controllo 2026-06-05: termini ufficiali molto favorevoli per opere in pubblico dominio e dati CC0; infrastruttura Rosetta/Alma con OAI-PMH documentato. Da verificare se l'accesso immagini/PDF espone URL pubblici stabili o manifest IIIF/API utilizzabili senza scraping | A/B - candidato forte per metadata e possibile download puntuale; prima servono campione, endpoint e policy item-level |
| `biblioteca_digitale_lombarda` | Biblioteca Digitale Lombarda | Italia / Lombardia | `https://www.bdl.servizirl.it/`; esempi record pubblici `https://www.bdl.servizirl.it/vufind/Record/BDL-OGGETTO-133442`; endpoint PDF pubblici `https://www.bdl.servizirl.it/bdl/public/rest/srv/item/12404/pdf` | Alta per storia locale lombarda, periodici, monografie, archivi e fondi civici | Controllo 2026-06-05: portale pubblico VuFind con record e PDF pubblici; molti record dichiarano CC BY-NC-ND, quindi utili per studio/ricerca ma con limiti non commerciale/no-derivati. La tecnica PDF REST appare promettente, ma va verificata su item espliciti, con policy `D_ONLY` o `R_LIMITED` e senza estensione generica | B - candidato tecnico interessante ma piu vincolato di BDT/BEIC; sonda su singoli item pubblici |
| `ambrosiana_digitale` | Veneranda Biblioteca Ambrosiana - Digital Library | Italia / Lombardia ecclesiastica e manoscritti | `https://www.ambrosiana.it/en/study/the-digital-library/` | Alta per manoscritti, codici, fondi storici e fonti culturali collegate a Milano e Lombardia | Controllo 2026-06-05: la pagina ufficiale descrive accesso libero e uso dello standard IIIF; non e ancora sufficiente una policy di download/riuso puntuale per ATK-Pro. Data la natura dei fondi, trattare con cautela finche non sono verificati termini, licenze per item e pattern manifest | B/C - ottima sonda IIIF, ma non integrare prima di policy e campioni chiari |
| `rovereto_digital_library` | Rovereto Digital Library / Biblioteca Tartarotti | Italia / Trentino | `https://www.cultura.trentino.it/Biblio/Approfondimenti/Rovereto-digital-library-La-storia-a-portata-di-click` | Media-alta per storia locale trentina, fotografie, documenti d'archivio, riviste e contesto familiare | Controllo 2026-06-05: fonte istituzionale descrive piattaforma DSpace GLAM con ecosistema IIIF; resta da trovare portale operativo, termini di riuso, endpoint e campioni pubblici. Buona pista tecnica, ma non ancora candidato implementativo | B/C - tenere in scouting; prima verificare portale vivo e condizioni d'uso |
...
| `biblioteca_digitale_trentina` | Italia / Trentino | BDT, pagina Riuso e servizio Comune di Trento | Priorita tecnica immediata tra le biblioteche digitali italiane: policy di riuso molto favorevole e download gratuito dichiarato; verificare endpoint/IIIF |
| `beic_digitale` | Italia / Lombardia | BEIC termini d'uso e infrastruttura/OAI-PMH | Candidato forte per pubblico dominio, CC0 sui dati e metadata; da sondare tecnicamente su immagini/PDF o manifest |
| `biblioteca_digitale_lombarda` | Italia / Lombardia | BDL/VuFind, record pubblici e PDF REST | Pista tecnica interessante ma con molti record CC BY-NC-ND; valutare solo download puntuale/range limitato |
| `ambrosiana_digitale` | Italia / Lombardia ecclesiastica | Digital Library Ambrosiana e IIIF dichiarato | Sonda IIIF di valore alto, ma da subordinare a termini e licenze item-level |
| `rovereto_digital_library` | Italia / Trentino | scheda istituzionale DSpace GLAM/IIIF | Tenere in scouting finche non sono verificati portale operativo, termini e campioni |
| `biblioteche_digitali_locali_iiif` | Italia | esempi da selezionare da biblioteche civiche, universitarie, comunali o regionali | Buona pista tecnica se IIIF pubblico e policy prudente `R_LIMITED`; il primo sottoblocco e BDT/BEIC/BDL/Ambrosiana/Rovereto |
...
- Avviare il sottoblocco biblioteche digitali italiane da
  `biblioteca_digitale_trentina`, poi `beic_digitale`,
  `biblioteca_digitale_lombarda`, `ambrosiana_digitale` e
  `rovereto_digital_library`, mantenendo separate le decisioni tecniche da
  quelle di riuso.
