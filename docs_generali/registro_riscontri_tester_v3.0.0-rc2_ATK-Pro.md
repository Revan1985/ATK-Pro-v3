...
| Ricerca Assistita AI | Fix in RC2 | Corretto errore Gemini `cannot access local variable 'json' where it is not associated with a value`. In attesa di conferma tester. |
| OCR Gemini su immagini divise | Fix in RC2 | Corretto merge TOP/BOTTOM con deduplicazione righe sovrapposte e riempimento colonne vuote. In attesa di conferma tester. |
...
| RC2-004 | 2026-06-23 | Enrico Davini | Windows, portable RC1, Gemini paid | Ricerca Assistita AI | Errore `cannot access local variable 'json' where it is not associated with a value`. | Fix in RC2 | Corretto in RC2; attendere conferma con stessa chiave Gemini. |
| RC2-005 | 2026-06-23 | Enrico Davini | Windows, portable RC1, Gemini paid | OCR Gemini | OCR su censimento Toscana 1841 produce due file testo con righe 8-14 duplicate nel merge finale. | Fix in RC2 | Corretto in RC2; attendere conferma sullo stesso documento. |
...
|---|---:|---|---|
| Ricerca Assistita AI con Gemini | Alta | Stessa chiave Gemini usata in RC1, query semplice | Nessun errore `json`; risultato o errore provider gestito in modo leggibile. |
| OCR Gemini su censimento Toscana 1841 | Alta | Stessa immagine usata in RC1 da Enrico | File finale senza righe duplicate da sovrapposizione TOP/BOTTOM. |
