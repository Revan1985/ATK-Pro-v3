...
| `matricula` | Matricula Online | Europa centrale | Manifest sintetico da viewer HTML e hosted-images | Alto | Immagini registri CC BY-NC-ND 2.0; pubblicazioni e dati soggetti a obblighi/leggi locali | Mantenere con limite non commerciale, no derivati, citazione/link e senza bulk scraping |
...
| `internet_archive` | Internet Archive | Internazionale | Manifest sintetico da metadata/files/BookReaderImages | Medio-Alto | Licenza e disponibilita variabili per item; alcuni item sono prestito o no-download | Supportare solo item pubblici scaricabili, con licenza/diritti chiari e senza aggirare prestito/no-download |
...
## Fonti ufficiali consultate - batch 4

Data verifica: 2026-05-26.

| Chiave | Fonti ufficiali | Indicazioni operative emerse | Decisione provvisoria |
|---|---|---|---|
| `findbuch` | Funzioni FINDBUCH.Net: `https://www.findbuch.net/hp/Funktionen/`; Impressum FINDBUCH.Net: `https://www.findbuch.net/hp/Impressum/`; pagina Provincia Bolzano Kirchenbuecher Suedtirol: `https://beni-culturali.provincia.bz.it/de/landesarchiv/kirchenbucher-sudtirol` | FINDBUCH.Net e una piattaforma per presentare fondi di oltre 120 enti, con immagini gestibili dai singoli archivi e subdomain con contenuti redazionali terzi. Per Kirchenbuecher Suedtirol la Provincia descrive la messa online dei microfilm fino alle soglie privacy, ma la fonte tecnica resta viewer/HTML non standard. | Non estendere genericamente Findbuch; mantenere solo istanze pubbliche gia verificate e con range puntuale, senza login, ordini, aree riservate o download massivi. |
| `matricula` | Nutzungsbedingungen: `https://data.matricula-online.eu/de/nutzungsbedingungen/`; Impressum: `https://data.matricula-online.eu/de/impressum/` | Le immagini dei registri su `data.matricula-online.eu` sono dichiarate CC BY-NC-ND 2.0; sono vietati usi commerciali e opere derivate, e l'utente deve rispettare leggi su stato civile/privacy e informare archivio/diocesi in caso di pubblicazioni. | Supporto solo per consultazione/download puntuale non commerciale, con citazione/link e senza rielaborazioni derivate o bulk. |
| `internet_archive` | Terms: `https://archive.org/about/terms`; API docs: `https://archive.org/services/docs/api/`; Metadata API: `https://archive.org/metadata/` | Internet Archive espone metadata/file access per item pubblici, ma licenza, `licenseurl`, disponibilita file, prestito controllato e flag come no-download variano per item. | Supportare solo item pubblici scaricabili e chiaramente licenziati/pubblico dominio; non aggirare prestito digitale, restrizioni no-download o rimozioni contenuto. |
